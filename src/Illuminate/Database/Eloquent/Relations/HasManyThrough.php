...
class HasManyThrough extends Relation
{
    ...
    protected bool $addLaravelThroughKey = true;
    ...
    public function withoutThroughKey(bool $addLaravelThroughKey = false): static
    {
        $this->addLaravelThroughKey = $addLaravelThroughKey;
    ...
    protected function shouldSelect(array $columns = ['*'])
    {
        ...
        //if ($this->addLaravelThroughKey) {
        if (true) {
            $columns = array_merge($columns, [$this->getQualifiedFirstKeyName().' as laravel_through_key']);
        }
    ...
    {
        if (! in_array('laravel_through_key', $groups)) {
            //$this->withoutThroughKey();
        }
